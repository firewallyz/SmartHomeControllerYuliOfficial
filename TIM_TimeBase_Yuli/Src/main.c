/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : code file for timer demonstration
  ******************************************************************************
  * @author
  *
  * Created by Yuli Zhou
  * Some code are from STMicroelectronics' TiM_TimeBase template.
  *
  *
  ******************************************************************************
  */
...
/* integer variable for controlling the timer interrupt logic */
int flipLED = 2;
